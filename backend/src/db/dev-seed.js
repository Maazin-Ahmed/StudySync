// dev-seed.js — DEVELOPMENT ONLY. Never run in production.
...
const SEED_USERS = [
    ...
    { name: 'Meera Patel', email: 'meera@demo.com', avatar: '👩‍🎓', institution: 'BITS Bangalore', education: '2nd Year, ECE', bio: 'Love math and circuits. Morning study partner needed.', subjects: ['Mathematics', 'Physics', 'Computer Networks'], goal: 'College Studies', availability: ['Morning', 'Afternoon'], modes: ['silent', 'doubt'], rating: 4.6, total_sessions: 12 },
    { name: 'Arjun Nair', email: 'arjun@demo.com', avatar: '🎓', institution: 'NIT Calicut', education: 'Final Year, CS', bio: "CAT 2026 + coding interviews.", subjects: ['Data Structures & Algorithms', 'CAT Prep'], goal: 'Exam Preparation', availability: ['Night'], modes: ['discussion'], rating: 4.5, total_sessions: 8 },
    ...
    { name: 'Dev Sharma', email: 'dev@demo.com', avatar: '🧠', institution: 'VIT Chennai', education: 'Final Year, CS', bio: 'ML research + placement. All study modes welcome.', subjects: ['Machine Learning', 'Data Structures & Algorithms'], goal: 'Placement Preparation', availability: ['Morning', 'Night'], modes: ['silent', 'discussion'], rating: 4.7, total_sessions: 20 },
    { name: 'Prachi Joshi', email: 'prachi@demo.com', avatar: '👩‍⚕️', institution: 'AIIMS Delhi', education: '2nd Year, MBBS', bio: 'Need serious, focused study buddies.', subjects: ['Biology', 'Chemistry'], goal: 'College Studies', availability: ['Evening', 'Night'], modes: ['silent'], rating: 4.8, total_sessions: 35 },
    { name: 'Aditya Kumar', email: 'aditya@demo.com', avatar: '🚀', institution: 'IIIT Hyderabad', education: 'Final Year, CS', bio: 'Placed at Google! Happy to help with DSA.', subjects: ['Data Structures & Algorithms', 'Computer Networks', 'Operating Systems'], goal: 'Placement Preparation', availability: ['Morning', 'Evening', 'Night'], modes: ['doubt', 'discussion'], rating: 4.9, total_sessions: 55 },
...
async function seed() {
    ...
    console.log(`✅ Seeded ${SEED_USERS.length} dev users (password: demo1234)`);
    await pool.end();
}
